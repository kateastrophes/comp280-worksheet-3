...
{   
    ...
    void Start()
    {
        ...
        GameEvents.current.onEnterPoisenCollision += IncreasePoisen;
        GameEvents.current.onExitPoisenCollision += DecreasePoisen;
    }

    private void IncreasePoisen()
    {
        plantsCount++;
        checkedIfDecreasing();
    }

    private void DecreasePoisen()
    {
        plantsCount--;
        checkedIfDecreasing();
    }
